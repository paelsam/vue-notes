...
console.log('Hola, si quieres ver la ejecución de cada uno de los ejemplos, puedes hacerlo en la consola de tu navegador');
console.info('Recuerda descomentar la importación de cada uno de los ejemplos en el archivo main.ts')
